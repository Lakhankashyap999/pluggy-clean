...
export default function FanMotorDetail() {
  const navigate = useNavigate()
  const [selectedIssue, setSelectedIssue] = useState(null)

  const service = {
    title: "Fan & Motor Service",
    desc: "Expert repair of ceiling fans, exhaust fans, and motors.",
    rating: "4.6",
    basePrice: "₹199 onwards",
    issues: [
      { issue: "Ceiling Fan Installation", price: 199 },
      { issue: "Fan Regulator Replacement", price: 149 },
      { issue: "Motor Bearing Noise", price: 399 },
      { issue: "Exhaust Fan Repair", price: 299 },
      { issue: "New Fan Installation", price: 499 },
    ],
  }
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-6xl mx-auto px-4 py-8 grid md:grid-cols-2 gap-8">
        <div>
          ...
          <button
            onClick={() => navigate(`/request/fan-motor`, { state: { selectedIssue, finalAmount } })}
