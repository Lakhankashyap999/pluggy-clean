  ...
  return (
    <div className="min-h-screen flex flex-col">
      ...
      <motion.div
        ...
        className="sticky top-0 z-40 w-full px-4 sm:px-6 py-3 bg-white/80 backdrop-blur-md"
      >
        <div className="flex items-center gap-2 rounded-full border border-gray-200 bg-white px-3 py-2 shadow-sm max-w-full sm:max-w-md lg:max-w-2xl mx-auto">
          <input
            type="text"
            value={query}
            onChange={handleChange}
            placeholder="Search services..."
            className="flex-1 bg-transparent border-none focus:outline-none px-2 py-1 text-sm sm:text-base"
          />
          <button
      ...
      {suggestions.length > 0 && (
        <div className="absolute left-0 right-0 top-16 mx-4 sm:mx-6 bg-white shadow-lg rounded-lg border max-h-48 overflow-y-auto z-50">
          {suggestions.map((s, i) => (
            <div
              key={i}
