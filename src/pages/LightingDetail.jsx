...
export default function LightingDetail() {
  const navigate = useNavigate()
  const [selectedIssue, setSelectedIssue] = useState(null)

  const service = {
    title: "Lighting Service",
    desc: "Installation & fixing of lights, tube lights, and fancy setups.",
    rating: "4.5",
    basePrice: "₹149 onwards",
    issues: [
      { issue: "Bulb/Tube Light Replacement", price: 149 },
      { issue: "LED Panel Installation", price: 249 },
      { issue: "Chandelier Installation", price: 799 },
      { issue: "Fancy Light Setup", price: 999 },
      { issue: "Outdoor Lighting Fix", price: 399 },
    ],
  }
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-6xl mx-auto px-4 py-8 grid md:grid-cols-2 gap-8">
        <div>
          ...
          <button
            onClick={() => navigate(`/request/lighting`, { state: { selectedIssue, finalAmount } })}
